...
Order.create(price: 12345.54321, interest_rate: 0.15, tariff: "standard", status: "started", from: "Sablina", to: "Grablina", client: clients.last)
Order.create(price: 65.6, interest_rate: 0.5, tariff: "premium", status: "started", from: "Safina", to: "Grafina", client: clients.first, driver: drivers.last)
